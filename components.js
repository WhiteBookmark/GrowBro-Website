		...
		<div class="container">
			<div class="footer-grid">
				...
				<div class="footer-column">
					<h4>Contact</h4>
					<ul class="footer-links">
						<li>Email: <a href="mailto:contact@growbro.com">contact@growbro.com</a></li>
						<li>Phone: <a href="tel:+971502177595">+971502177595</a></li>
						<li><a href="https://maps.app.goo.gl/dmbA475pYptq7Vdx6" target="_blank"
								rel="noopener noreferrer">Myriad, Academic City, Dubai, UAE</a></li>
					</ul>
				</div>
			</div>
